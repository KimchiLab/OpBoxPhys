...
for i_subj = 1:num_subj
    ...
    % Plot fake data
    temp_data = zeros(num_sec_to_plot * subjects(1).Fs, subjects(i_subj).num_analog+subjects(i_subj).num_counter+subjects(i_subj).num_digital); % For 1 channel, ends up as multiple rows, 1 col
