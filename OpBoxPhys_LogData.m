...
% 1. stream to multiple subjects/files "simultaneously" (loop over subjects)
...
% But lost some time when converted prior timestamps from double to single
% Though may not really need timestamps (but helpful with multiple subjects--aligning across single NI session)
